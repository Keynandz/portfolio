...
const milestones = [
  {
    ...
    highlights: [
      ...
      "Lead cross-domain research spanning IoT, AI model integration, and system architecture to drive innovation across the organization",
  ...
  },
  {
    ...
    highlights: [
      ...
      "Contributed to 4 repositories, shipping production features with Go, PostgreSQL, Redis, and Docker",
    ],
